...
Modern Kotlin language for Android development.

- [**Language Patterns**](kotlin/language/SKILL.md) (P0) - Data classes, Sealed classes, Null safety, Extension functions.
- [**Coroutines**](kotlin/coroutines/SKILL.md) (P0) - Structured concurrency, Flow, Dispatchers, Exception handling.
- [**Flow Advanced Patterns**](kotlin/flow-advanced/SKILL.md) (P0) - Lazy observation, StateIn/ShareIn, SharingStarted, Lifecycle-aware collection.
- [**Koin DI**](kotlin/koin-di/SKILL.md) (P1) - Lightweight dependency injection, DSL-based configuration.
- [**Hilt DI**](kotlin/hilt-di/SKILL.md) (P1) - Compile-time dependency injection, Dagger-based, Android-optimized.
- [**Best Practices**](kotlin/best-practices/SKILL.md) (P1) - Naming conventions, Immutability, Code organization.
- [**Tooling**](kotlin/tooling/SKILL.md) (P1) - Gradle, Detekt, ktlint, KSP.

### 🎨 Jetpack Compose (Framework)

Modern declarative UI framework for Android.

- [**Architecture**](jetpack-compose/architecture/SKILL.md) (P0) - MVVM, MVI, Clean Architecture, Use Cases.
- [**State Management**](jetpack-compose/state-management/SKILL.md) (P0) - StateFlow, State hoisting, Events.
- [**UI Components**](jetpack-compose/ui-components/SKILL.md) (P1) - Composables, Modifiers, Lists, Theming.
- [**Navigation**](jetpack-compose/navigation/SKILL.md) (P1) - Type-safe routing, Deep links, Bottom navigation.
- [**Performance**](jetpack-compose/performance/SKILL.md) (P1) - Recomposition optimization, Stability.
- [**Testing**](jetpack-compose/testing/SKILL.md) (P2) - UI tests, Semantics, Test rules.

### 📱 Android XML (Legacy UI)

Traditional XML-based Android UI development.

- [**Layouts**](android-xml/layouts/SKILL.md) (P1) - ConstraintLayout, ViewBinding, Layout optimization.
- [**Resources**](android-xml/resources/SKILL.md) (P1) - Strings, Colors, Themes, Drawables, Localization.
- [**Best Practices**](android-xml/best-practices/SKILL.md) (P1) - RecyclerView, Fragments, Lifecycle.

### 🌍 Kotlin Multiplatform (KMP)

Share Kotlin code across Android, iOS, Web, Desktop platforms.

- [**KMP Fundamentals**](kmp/SKILL.md) (P0) - Architecture, expect/actual, Networking, Database, iOS integration.

### 🚀 Compose Multiplatform (CMP)

Build native UIs for multiple platforms with Jetpack Compose.

- [**Compose Multiplatform**](compose-multiplatform/SKILL.md) (P0) - Shared UI, Navigation, Resources, Platform-specific features.
